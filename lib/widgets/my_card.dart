    ...
    return AspectRatio(
      ...
      child: Container(
        decoration: ShapeDecoration(
          image:
              const DecorationImage(image: AssetImage(Assets.imagesCreditCard)),
        ...
        child: Column(
          ...
          children: [
            ListTile(
              ...
              subtitle: Text(
                'Syah Bandi',
                style: AppStyle.styleRegular20.copyWith(color: Colors.white),
              ),
              ...
              child: Column(
                ...
                children: [
                  Text(
                    '0918 8124 0042 8129',
                    style:
                        AppStyle.styleSemiBols24.copyWith(color: Colors.white),
                  ),
                  Text(
                    '12/20 - 124',
                    style:
